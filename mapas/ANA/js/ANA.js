      ...
      var outSuper = L.geoJSON(outSuper3, {
        pointToLayer: function (geom, latlng) {
          switch (geom.properties.FIN_TFN_DS) {
            ...
            case 'Irrigaçăo': return L.marker(latlng, {icon: Icon_f57ab6});
            case 'Mineraçăo - Extraçăo de AreiaCascalho em Leito de Rio': return L.marker(latlng, {icon: Icon_a83800});
            case 'Mineraçăo - Outros Processos Extrativos': return L.marker(latlng, {icon: Icon_a83800});
            case 'Obras Hidráulicas': return L.marker(latlng, {icon: Icon_005ce6});
            case 'Outras': return L.marker(latlng, {icon: Icon_59f0c0});
            case 'ReservatórioBarramentoRegularizaçăo de Vazőes para Usos Múltiplos': return L.marker(latlng, {icon: Icon_59f769});
