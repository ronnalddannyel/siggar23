  ...
  var areaProjeto_4mf = L.geoJSON(areaProjeto1_4mf, {
    color: "black",
      onEachFeature: function (feature, layer) {
        ...
        layer.bindPopup('<h6><b>Área do Projeto</b></h6><b>Processo: </b>'+feature.properties.n_processo+'<br><b>Código da Atividade: </b>'+codFemarh+'<br><b>Descrição: </b> '+feature.properties.descr_ativ+'<br><b>Área: </b> '+feature.properties.area+'<br><b>Tipo do Projeto: </b> '+tipoProjeto);
      }
  });
