    ...
    function clickMap (){
     ...
     monitor.eachLayer(function (layer) {
      ...
      if(layer.feature.properties.fk_tip_aut == 1){
       ...
       if (isInside){
           //selPoly.push(layer.feature);
           b = '<b>Código da Área do Imóvel: </b>'+layer.feature.properties.fk_ati+'<br><b>Código da Área do Projeto: </b> '+layer.feature.properties.fk_ap+'<br><b>Nº do Processo: </b>'+layer.feature.properties.n_processo+'<br><b>Classificação: </b> '+layer.feature.properties.fk_corte_fora_proj+'<br><b>Área Monitorada:</b> '+layer.feature.properties.area+' ha.<br><b>Nº da Autorização: </b> '+layer.feature.properties.n_autoriza+'<br><b>Início da Vigência: </b> '+layer.feature.properties.vig_inicia+'<br><b>Fim da Vigênica:</b> '+layer.feature.properties.vig_fim+'<br><b>Intervalo da Vigência: </b>'+layer.feature.properties.vig_interv+'<br><b>Data do Registro: </b> '+layer.feature.properties.data_reg+'<br><b>Situação do Monitoramento: </b> '+MonitSit+'<br><b>Licença de Autorização: </b> '+LicenAutor;
