...
<section class="hero gdd is-fullheight">
<div class="hero-body">
...
"https://cdnjs.cloudflare.com/ajax/libs/Chart.js/1.0.1/Chart.min.js">
  ...
  $sql = "SELECT * from monitoramento.ap";

  if ($result = pg_query($conn, $sql)) {
  
      // Return the number of rows in result set
      $qtdpesca = pg_num_rows( $result );
   ...
   ?>
    ...
    <script>
      var chart = bb.generate({
        data: {
          columns: [
            ["Pescadores",   <?php echo $qtdpesca; ?> ],
            ["Embarcações", <?php echo $a1; ?>],
            ["Usuarios", <?php echo $a2; ?>],
          ],
          type: "donut",
